...
import game_Tetris.Shape.Tetrominoe;
...
public class Board extends JPanel {
    ...
    private int sec;
    private java.util.Timer timerSec = new java.util.Timer(); 
    ...
    public Board(PlayWindow parent) {

        initBoard(parent);
    }

    private void initBoard(PlayWindow parent) {

        setFocusable(true);
        modcheck = parent.getmod();
    ...
    private void modcomplet() {
    	if(modcheck ==1&&numLinesRemoved > 150) {
        ...
        if(modcheck ==2&&numLinesRemoved > 40) {
        	curPiece.setShape(Tetrominoe.NoShape);
            timer.stop();
